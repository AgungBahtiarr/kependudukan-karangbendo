...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::patch('/{id}/status', [UserController::class, 'updateUserStatus'])
            ->middleware('can:update_user_status')
    ...
    Route::prefix('warga')->group(function () {
        Route::get('', [WargaController::class, 'index'])
            ->middleware('can:read_wargas', CleanSession::class)
            ->name('wargas.index');

        Route::get('/create/1', [WargaController::class, 'create1'])
            ->middleware('can:create_wargas')
            ->name('wargas.create1');
        Route::get('/create/2', [WargaController::class, 'create2'])
            ->middleware('can:create_wargas')
            ->name('wargas.create2');

        Route::post('/store/back', [WargaController::class, 'backTo'])
            ->middleware('can:create_wargas')
            ->name('wargas.back');
        Route::post('/store/1', [WargaController::class, 'store1'])
            ->middleware('can:create_wargas')
            ->name('wargas.store1');
        ...
        Route::get('/edit/1/{id}', [WargaController::class, 'edit1'])
            ->middleware('can:edit_wargas')
            ->name('wargas.edit1');
        Route::get('/edit/2/{id}', [WargaController::class, 'edit2'])
            ->middleware('can:edit_wargas')
            ->name('wargas.edit2');

        Route::patch('/edit/back', [WargaController::class, 'backToEdit'])
            ->middleware('can:edit_wargas')
            ->name('wargas-edit.back');

        Route::patch('/update1', [WargaController::class, 'update1'])
            ->middleware('can:update_wargas')
            ->name('wargas.update1');
        Route::patch('/update', [WargaController::class, 'update'])
            ->middleware('can:update_wargas')
            ->name('wargas.update');

        Route::patch('/{id}/status', [WargaController::class, 'updateWargaStatus'])
            ->middleware('can:update_wargas_status')
            ->name('wargas.status.update');

        Route::get('/{id}', [WargaController::class, 'show'])
            ->middleware('can:read_wargas')
            ->name('wargas.show');
        // Route::get('/2/{id}', [WargaController::class, 'show2'])->middleware('can:read_wargas')->name('wargas.show2');

        Route::get('/verify/{id}', [WargaController::class, 'verify'])
            ->middleware('can:edit_wargas')
            ->name('wargas.verify');
    ...
    Route::prefix('dawis')->group(function () {
        Route::get('', [KeikutsertaanKegiatanDawisController::class, 'index'])
            ->middleware('can:read_dawis')
            ->name('dawis.index');
        Route::get('/create/{nik}', [KeikutsertaanKegiatanDawisController::class, 'create'])
            ->middleware('can:create_dawis')
            ->name('dawis.create');
        Route::get('/create2/{nik}', [KeikutsertaanKegiatanDawisController::class, 'create2'])
            ->middleware('can:create_dawis')
            ->name('dawis.create2');

        Route::post('/backTo', [KeikutsertaanKegiatanDawisController::class, 'backTo'])
            ->middleware('can:create_dawis')
            ->name('dawis.backTo');

        Route::post('/store', [KeikutsertaanKegiatanDawisController::class, 'store'])
            ->middleware('can:create_dawis')
            ->name('dawis.store');
        Route::post('/store2', [KeikutsertaanKegiatanDawisController::class, 'store2'])
            ->middleware('can:create_dawis')
            ->name('dawis.store2');

        Route::get('/edit/{nik}', [KeikutsertaanKegiatanDawisController::class, 'edit'])
            ->middleware('can:edit_dawis')
            ->name('dawis.edit');
        Route::get('/edit2/{nik}', [KeikutsertaanKegiatanDawisController::class, 'edit2'])
            ->middleware('can:edit_dawis')
            ->name('dawis.edit2');

        Route::patch('/update', [KeikutsertaanKegiatanDawisController::class, 'update'])
            ->middleware('can:update_dawis')
            ->name('dawis.update');
        Route::patch('/update2', [KeikutsertaanKegiatanDawisController::class, 'update2'])
            ->middleware('can:update_dawis')
            ->name('dawis.update2');

        Route::get('/{id}', [KeikutsertaanKegiatanDawisController::class, 'show'])
            ->middleware('can:read_dawis')
            ->name('dawis.show');
    ...
    Route::prefix('cargas')->group(function () {
        Route::get('', [CatatanRumahTanggaController::class, 'index'])
            ->middleware('can:read_cargas', CleanSession::class)
            ->name('cargas.index');
        Route::get('/create1', [CatatanRumahTanggaController::class, 'create1'])
            ->middleware('can:create_cargas')
            ->name('cargas.create1');
        Route::get('/create2', [CatatanRumahTanggaController::class, 'create2'])
            ->middleware('can:create_cargas')
            ->name('cargas.create2');
        Route::get('/create3', [CatatanRumahTanggaController::class, 'create3'])
            ->middleware('can:create_cargas')
            ->name('cargas.create3');

        Route::post('/store1', [CatatanRumahTanggaController::class, 'store1'])
            ->middleware('can:create_cargas')
            ->name('cargas.store1');
        Route::post('/store2', [CatatanRumahTanggaController::class, 'store2'])
            ->middleware('can:create_cargas')
            ->name('cargas.store2');
        Route::post('/store3', [CatatanRumahTanggaController::class, 'store3'])
            ->middleware('can:create_cargas')
            ->name('cargas.store3');

        Route::post('/store/back', [CatatanRumahTanggaController::class, 'backTo'])
            ->middleware('can:create_cargas')
            ->name('cargas.back');
        Route::post('/store/back2', [CatatanRumahTanggaController::class, 'backTo2'])
            ->middleware('can:create_cargas')
            ->name('cargas.back2');

        Route::get('/show/{id}', [CatatanRumahTanggaController::class, 'show'])
            ->middleware('can:read_cargas')
            ->name('cargas.show');
        Route::get('/show2/{id}', [CatatanRumahTanggaController::class, 'show2'])
            ->middleware('can:read_cargas')
            ->name('cargas.show2');
        // Route::get('/show2/{id}', [CatatanRumahTanggaController::class, 'show2'])->middleware('can:read_cargas')->name('cargas.show2');

        Route::get('/verify/{id}', [CatatanRumahTanggaController::class, 'verify'])
            ->middleware('can:edit_cargas')
            ->name('cargas.verify');
    ...
    Route::prefix('pekarangans')->group(function () {
        Route::get('', [PemanfaatanTanahPekaranganController::class, 'index'])
            ->middleware('can:read_pekarangans')
            ->name('pekarangans.index');
        Route::get('/create/{id}', [PemanfaatanTanahPekaranganController::class, 'create'])
            ->middleware('can:create_pekarangans')
            ->name('pekarangans.create');
        Route::post('/store', [PemanfaatanTanahPekaranganController::class, 'store'])
            ->middleware('can:create_pekarangans')
            ->name('pekarangans.store');
        Route::get('/detail/{id}/{nkk}', [PemanfaatanTanahPekaranganController::class, 'show'])
            ->middleware('can:read_pekarangans')
            ->name('pekarangans.show');
        Route::get('/edit/{id}', [PemanfaatanTanahPekaranganController::class, 'edit'])
            ->middleware('can:edit_pekarangans')
            ->name('pekarangans.edit');
        Route::patch('/update', [PemanfaatanTanahPekaranganController::class, 'update'])
            ->middleware('can:edit_pekarangans')
            ->name('pekarangans.update');
    });

    Route::prefix('industries')->group(function () {
        Route::get('', [IndustriRumahTanggaController::class, 'index'])
            ->middleware('can:read_industries')
            ->name('industries.index');
        Route::get('/create/{id}', [IndustriRumahTanggaController::class, 'create'])
            ->middleware('can:create_industries')
            ->name('industries.create');
        Route::post('/store', [IndustriRumahTanggaController::class, 'store'])
            ->middleware('can:create_industries')
            ->name('industries.store');
        Route::get('/detail/{id}/{nkk}', [IndustriRumahTanggaController::class, 'show'])
            ->middleware('can:read_industries')
            ->name('industries.show');
        Route::get('/edit/{id}', [IndustriRumahTanggaController::class, 'edit'])
            ->middleware('can:edit_industries')
            ->name('industries.edit');
        Route::patch('/update', [IndustriRumahTanggaController::class, 'update'])
            ->middleware('can:edit_industries')
    ...
    Route::prefix('bansos')->group(function () {
        Route::get('', [PenerimaBansosController::class, 'index'])
            ->middleware('can:read_bansos')
            ->name('bansos.index');
        Route::get('/create', [PenerimaBansosController::class, 'create'])
            ->middleware('can:create_bansos')
            ->name('bansos.create');
        Route::post('/store', [PenerimaBansosController::class, 'store'])
            ->middleware('can:create_bansos')
            ->name('bansos.store');
        Route::get('/edit/{id}', [PenerimaBansosController::class, 'edit'])
            ->middleware('can:edit_bansos')
            ->name('bansos.edit');
        Route::patch('/update/{id}', [PenerimaBansosController::class, 'update'])
            ->middleware('can:edit_bansos')
            ->name('bansos.update');
