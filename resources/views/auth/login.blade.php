                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            ...
                            <form action="{{ route('login') }}" method="POST" id="login" name="login">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="floating-label form-group">
                                            <input
                                                ...
                                                type="text" placeholder="" name="username" value="{{ old('username') }}">
                                ...
                                <button type="submit" class="d-block btn btn-primary"><i class="fas fa-sign-in-alt"></i>
                                    Login</button>
                            </form>
                        </div>
                        <div class="col-lg-7 mb-lg-0 mb-4 mt-lg-0 mt-4 d-none d-lg-block text-center">
                            <img src="{{ asset('assets/images/logo/logo-banyuwangi.svg') }}" class="img-fluid"
