                ...
                <table id="datatable" class="table data-table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Edit Data Kader -->
                                <a href="{{ route('users.update', $user->id) }}" class="btn btn-warning btn-sm mr-2 my-1 edit-btn" data-toggle="modal" data-target="#editUserModal" data-name="{{ $user->name }}" data-nik="{{ $user->nik }}" data-username="{{ $user->username }}">
