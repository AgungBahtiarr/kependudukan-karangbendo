...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create("catatan_rumah_tanggas", function (Blueprint $table) {
            ...
            $table->integer("jumlah_buta_baca")->autoIncrement(false);
            $table->integer("jumlah_buta_tulis")->autoIncrement(false);
            $table->integer("jumlah_buta_hitung")->autoIncrement(false);
            $table->integer("jumlah_berkebutuhan_khusus")->autoIncrement(false);
